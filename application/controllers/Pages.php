...
class Pages extends CI_Controller
{
    ...
    public function index($page = 'dashboard')
    {
        ...
        switch ($page) {
            //หน้าหลัก
            case 'dashboard':
                $data['title'] = 'หน้าแรก | ระบบบริหารจัดการอู่ณัฐวุฒิ';
                break;
            //รายการซ่อม
            case 'service_create':
                $data['title'] = 'รับงานซ่อม | ระบบบริหารจัดการอู่ณัฐวุฒิ';
                break;
            case 'service':
            ...
            //ลูกค้า
            case 'customer':
                $data['title'] = 'ทะเบียนรถที่เข้ารับบริการ';
                break;
            //รายงานต่างๆ 
            case 'report_service':
                $data['title'] = 'รายงานการส่งซ่อม';
                break;
    ...
    function customer_detail($cus_id){
        ...
        $data['title']= 'รายละเอียดประวัติการเข้าซ่อมทะเบียน '.$data['customer']->license_plate;
